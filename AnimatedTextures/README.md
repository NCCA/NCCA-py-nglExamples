...
500 GPU billboards (camera-facing quads built in a geometry shader from a single point each) sample one of 3 fire sprite-sheet textures, scrolling through 10 animation frames over time. Pure-black texels are discarded for chroma-key transparency.
