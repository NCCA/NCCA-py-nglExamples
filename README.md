...
|                <a href="MuJoCoNGL"><img src="MuJoCoNGL/MuJoCoNGL.png" width="220"></a>                 | [MuJoCoNGL](MuJoCoNGL)                             | Rigid body physics with MuJoCo, spawning bodies into a model that cannot be added to (OpenGL)   |
...
The initial phases were for the full port of NGL9Demos to PyNGL (C++ to Python conversion) and additional testing. Most of the work is shown in the docs section of the repository, and I have also written about various things on my blog [here](https://nccastaff.bournemouth.ac.uk/jmacey/post/).
