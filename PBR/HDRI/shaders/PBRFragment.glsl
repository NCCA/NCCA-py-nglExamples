...
// (https://learnopengl.com/PBR/Lighting), extended here with the full split-sum
...
//
// Unlike PBR/IBL (which cuts the prefilter stage), this demo bakes the full
// roughness-mipped GGX-prefiltered specular chain (see main.py's
// initializeGL / _render_cube_faces), so prefilteredColor below is a real
// per-roughness lookup into that chain rather than a single unblurred
// sample -- specular reflections blur out correctly as roughness increases.
