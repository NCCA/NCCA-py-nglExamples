...
Spheres are a real generated sphere mesh (`PrimData.sphere`); a hit
sphere is tinted red instead of drawn wireframe (wgpu has no practical
per-draw polygon-mode toggle against a pooled pipeline).
